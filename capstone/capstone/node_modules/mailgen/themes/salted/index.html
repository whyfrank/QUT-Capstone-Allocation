                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <!-- Table -->
                                    <% if (locals.table) { %>
                                    <table class="data-table" width="100%" cellpadding="0" cellspacing="0" style="margin: 50px 0 0 0; font-size: 16px; line-height: 25px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #666666;">
                                        <tr>
